  ...
  return (
    ...
    >
      <InfoSection title="데이터 출처">
        ...
        <p>
          일부 참고 도구(예: 대출 금리비교)는 금융감독원 금융상품통합비교공시 등
          다른 공공 API를 사용할 수 있으며, 해당 화면에서 출처를 따로
          표기합니다.
        </p>
      </InfoSection>

      <InfoSection title="날짜·집계 기준">
        <p>
          단지 상세 등의 거래 날짜는 기본적으로 실제 거래의 계약일을
          사용합니다. 시장동향의 일·주·월 구간은 거래의 계약일을 기준으로
          집계합니다. 반면 ‘오늘의 시장’은 서비스가 새롭게 확인한 거래를
          중심으로 보여주므로 계약일 기준 시장동향과 집계 시점이 다를 수
          있습니다.
        </p>
        <p>
          여기서 ‘새롭게 확인한 시점’은 공식 신고일을 의미하지 않습니다.
        </p>
      </InfoSection>
