...
export const REGION_APT_RANK_TIP =
  "가격 수준, 거래 활발도, 단지 규모 등을 종합해 같은 지역의 아파트를 비교한 집랩 순위예요.";
...
export const RANKING_TABS: ReadonlyArray<{
...
}> = [
  {
    id: "COMPOSITE",
    label: "종합",
    hint: "가격 수준, 거래 활발도, 단지 규모 등을 종합해 비교합니다.",
  },
  {
    id: "TRADE_VOLUME",
    label: "거래량",
...
export const ZIPLAB_RANK_TIP = [
  "거래 가격 수준과 거래 활발도, 단지 규모 등을 같은 지역·평형대 안에서 종합해, 단지가 지역 안에서 어느 정도인지 보여줍니다.",
