...
| parkrio | A | auto-safe | 2661 | 11→227 (+216) | market label OK |
| banpo-xi | A | auto-safe | 1056 | 17→191 (+174) | P4.5 rescue |
| jamsil-els | B | group-safe-label-unknown | 1647 | 9→162 (+153) | label-null UI OK |
| mokdong-7 | C | ambiguous | 672 | 8→8 (+0) | exclusive fallback |
| eunma | D | registry-abnormal | 1124 | 2→2 (+0) | exclusive fallback |
...
- 동률 false
- 취소 거래는 warehouse에 없음 (ingest resolve)
...
B는 label null 유지한 채 group 신고가 가능.  
C/D·전국 backfill은 여전히 불가.
