/**
 * Production INSERT of the verified Seoul wave-2 COMPLETE months.
 * Rebuilds the 182 rows from the committed Seoul wave-2 checkpoint. Does not call the fee API.
 * A second --commit of the same artifact is a no-op when every stored row already matches.
 *
 *   npx tsx scripts/mgmt-fee-canonical/apply-seoul-wave2.mts
 *   npx tsx scripts/mgmt-fee-canonical/apply-seoul-wave2.mts --commit
 */
...
const CHECKPOINT_SHA256 = "657d941f9e76aeb4310865f33c45f8d7d83b35b785a3f409e5005453c03dc1c4";
const DRYRUN_SHA256 = "8149b8f4d19d1b30b9b8598380b26e3e85d3229c858ae16a2629ddc05ee54e21";
const COHORT_SHA256 = "e3763bc0c77a9193723c14134ecbd94eda4653ffb7d9f89e8246380607e12f41";
const EXPECTED_BEFORE_ROWS = 1053;
const EXPECTED_BEFORE_COMPLEXES = 940;
const EXPECTED_AFTER_ROWS = 1235;
const EXPECTED_AFTER_COMPLEXES = 1122;
...
const DRYRUN_PATH = resolve(DIR, "seoul-wave2-dryrun.json");
const COHORT_PATH = resolve(DIR, "seoul-wave2-cohort.json");
const RESULT_PATH = resolve(DIR, "seoul-wave2-apply-result.json");
...
async function main(): Promise<void> {
  ...
  if (artifact.api_calls !== 2155 || artifact.reuse_confirmation_api_calls !== 0 || artifact.http_429 !== false) {
  ...
  if (
    !artifactSeoul ||
    artifactSeoul.targets !== 182 ||
    artifactSeoul.COMPLETE !== 182 ||
    artifactSeoul.would_insert !== 182 ||
  ...
  if (plans.length === 182 && seoul.length !== 182) {
  ...
  if (insertedSeoul !== 182) post.push("insert counts");
